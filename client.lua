...
RegisterNetEvent('Ayse_WeatherSync:updateWeather')
AddEventHandler('Ayse_WeatherSync:updateWeather', function(NewWeather, newblackout)
...
RegisterNetEvent('Ayse_WeatherSync:updateTime')
AddEventHandler('Ayse_WeatherSync:updateTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
...
AddEventHandler('playerSpawned', function()
    TriggerServerEvent('Ayse_WeatherSync:requestSync')
end)
...
RegisterNetEvent('Ayse_WeatherSync:notify')
AddEventHandler('Ayse_WeatherSync:notify', function(message, blink)
